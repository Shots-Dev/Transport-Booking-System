...
export default function App() {
  ...
  if (currentView === "login") {
    return <Login onBack={handleBackToHome} userType={userType} onLoginSuccess={handleLoginSuccess} />;
  }

  if (currentView === "dashboard") {
    return <CustomerDashboard onBack={handleBackToHome} onNavigateToWallet={() => setCurrentView("wallet")} onNavigateToAvailableCars={() => setCurrentView("availableCars")} />;
  }
  ...
  if (currentView === "availableCars") {
    return <AvailableCars onBack={() => setCurrentView("dashboard")} />;
  }
